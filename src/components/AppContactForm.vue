        ...
        <form @submit.prevent="SendForm()" method="post">
            <div class="row">
                <div class="col-6 my-3">
                    <label for="surname" class="control-label"><strong>Nome:</strong> </label>
                ...
                <div class="col-6 my-3">
                    <label for="surname" class="control-label"><strong>Cognome:</strong> </label>
                ...
                <div class="col-12 my-3">
                    <label for="content" class="control-label"><strong>Messaggio:</strong> </label>
